...
enum AppPaths {
    static let applicationSupport = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask).first?
        .appendingPathComponent("ReadAsMe", isDirectory: true)
        ?? FileManager.default.homeDirectoryForCurrentUser
            .appendingPathComponent("Library/Application Support/ReadAsMe", isDirectory: true)
    ...
    static var converterEnvironment: [String: String] {
        ...
        environment["READ_AS_ME_APP_SUPPORT"] = applicationSupport.path
